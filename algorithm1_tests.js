...
function algorithm1_tests() {
    ...
    // test 1
    let desc = "A simple test that draws two faces from four vertices and returns the face identifiers";
    let graph2 = {                                        
    ...
    // test 2
    desc = "A test that draws four triangular faces where five edges converge on one point";
    let graph1 = {
    ...
    // test 3
    desc = "Tests a graph where edges are drawn out of order";
    let graph3 = {
    ...
    // test 4
    desc = "Tests a graph where vertices may have both parallel and non-parallel outgoing edges. This was a bug in my original vertex sorting function.";
    let graph6 = {
    ...
    // test 5
    desc = "Tests a graph containing a concave face";
    let graph11 = {
